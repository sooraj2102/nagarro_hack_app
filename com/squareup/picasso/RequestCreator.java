...
public class RequestCreator
{
  ...
  public void fetch(Callback paramCallback)
  {
    ...
    return;
    label139: FetchAction localFetchAction = new FetchAction(this.picasso, localRequest, this.memoryPolicy, this.networkPolicy, this.tag, str, paramCallback);
    ...
    throws IOException
  {
    ...
    GetAction localGetAction = new GetAction(this.picasso, localRequest, this.memoryPolicy, this.networkPolicy, this.tag, str);
    return BitmapHunter.forRequest(this.picasso, this.picasso.dispatcher, this.picasso.cache, this.picasso.stats, localGetAction).hunt();
  }
  ...
  public void into(ImageView paramImageView, Callback paramCallback)
  {
    ...
    if (this.setPlaceholder)
      PicassoDrawable.setPlaceholder(paramImageView, getPlaceholderDrawable());
    ImageViewAction localImageViewAction = new ImageViewAction(this.picasso, paramImageView, localRequest, this.memoryPolicy, this.networkPolicy, this.errorResId, this.errorDrawable, str, this.tag, paramCallback, this.noFade);
  ...
  public void into(Target paramTarget)
  {
    ...
    if (!this.data.hasImage())
    {
      ...
      boolean bool2 = this.setPlaceholder;
      Drawable localDrawable2 = null;
      if (bool2)
        localDrawable2 = getPlaceholderDrawable();
      paramTarget.onPrepareLoad(localDrawable2);
      return;
    }
    Request localRequest = createRequest(l);
    ...
    boolean bool1 = this.setPlaceholder;
    Drawable localDrawable1 = null;
    if (bool1)
      localDrawable1 = getPlaceholderDrawable();
    paramTarget.onPrepareLoad(localDrawable1);
    TargetAction localTargetAction = new TargetAction(this.picasso, paramTarget, localRequest, this.memoryPolicy, this.networkPolicy, this.errorDrawable, str, this.tag, this.errorResId);
    this.picasso.enqueueAndSubmit(localTargetAction);
  }

  public RequestCreator memoryPolicy(MemoryPolicy paramMemoryPolicy, MemoryPolicy[] paramArrayOfMemoryPolicy)
  {
    if (paramMemoryPolicy == null)
      throw new IllegalArgumentException("Memory policy cannot be null.");
    this.memoryPolicy |= paramMemoryPolicy.index;
    if (paramArrayOfMemoryPolicy == null)
      throw new IllegalArgumentException("Memory policy cannot be null.");
    if (paramArrayOfMemoryPolicy.length > 0)
    {
      int i = paramArrayOfMemoryPolicy.length;
      for (int j = 0; j < i; j++)
      {
        MemoryPolicy localMemoryPolicy = paramArrayOfMemoryPolicy[j];
        if (localMemoryPolicy == null)
          throw new IllegalArgumentException("Memory policy cannot be null.");
        this.memoryPolicy |= localMemoryPolicy.index;
      }
    }
    return this;
  }

  public RequestCreator networkPolicy(NetworkPolicy paramNetworkPolicy, NetworkPolicy[] paramArrayOfNetworkPolicy)
  {
    if (paramNetworkPolicy == null)
      throw new IllegalArgumentException("Network policy cannot be null.");
    this.networkPolicy |= paramNetworkPolicy.index;
    if (paramArrayOfNetworkPolicy == null)
      throw new IllegalArgumentException("Network policy cannot be null.");
    if (paramArrayOfNetworkPolicy.length > 0)
    {
      ...
      for (int j = 0; j < i; j++)
      {
        ...
        if (localNetworkPolicy == null)
          throw new IllegalArgumentException("Network policy cannot be null.");
        this.networkPolicy |= localNetworkPolicy.index;
      }
    }
    return this;
  }
  ...
  {
    MemoryPolicy localMemoryPolicy = MemoryPolicy.NO_CACHE;
    MemoryPolicy[] arrayOfMemoryPolicy = new MemoryPolicy[1];
    arrayOfMemoryPolicy[0] = MemoryPolicy.NO_STORE;
    return memoryPolicy(localMemoryPolicy, arrayOfMemoryPolicy);
  }
