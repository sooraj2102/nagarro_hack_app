  ...
  implements Serializable
{
  ...
  Node<K, V> find(K paramK, boolean paramBoolean)
  {
    ...
    while (true)
    {
      ...
      continue;
      label185: localNode2 = new Node((Node)localObject1, paramK, localNode1, localNode1.prev);
      this.root = localNode2;
      this.size = (1 + this.size);
      this.modCount = (1 + this.modCount);
      return localNode2;
    }
    label233: Node localNode2 = new Node((Node)localObject1, paramK, localNode1, localNode1.prev);
    if (i < 0)
