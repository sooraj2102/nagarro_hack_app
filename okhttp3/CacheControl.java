    ...
    while (i1 < i2)
    {
      ...
      while (true)
      {
        ...
        if (i3 >= i4)
          break label490;
        int i5 = i3;
        int i6 = HttpHeaders.skipUntil(str2, i3, "=,;");
        ...
        while (true)
        {
          ...
          n = 0;
          break;
          int i7 = HttpHeaders.skipWhitespace(str2, i6 + 1);
          if ((i7 < str2.length()) && (str2.charAt(i7) == '"'))
          {
            int i8 = i7 + 1;
            int i9 = HttpHeaders.skipUntil(str2, i8, "\"");
            str4 = str2.substring(i8, i9);
            i3 = i9 + 1;
            continue;
          }
          i3 = HttpHeaders.skipUntil(str2, i7, ",;");
        ...
        {
          i = HttpHeaders.parseSeconds(str4, -1);
          continue;
        }
        if ("s-maxage".equalsIgnoreCase(str3))
        {
          j = HttpHeaders.parseSeconds(str4, -1);
          continue;
        }
        ...
        {
          k = HttpHeaders.parseSeconds(str4, 2147483647);
          continue;
        }
        if ("min-fresh".equalsIgnoreCase(str3))
        {
          m = HttpHeaders.parseSeconds(str4, -1);
          continue;
        }
