...
public final class CipherSuite
{
  ...
  {
    Object localObject = (CipherSuite)INSTANCES.get(paramString);
    CipherSuite localCipherSuite2;
    if (localObject == null)
    {
      CipherSuite localCipherSuite1 = new CipherSuite(paramString);
      localCipherSuite2 = (CipherSuite)INSTANCES.putIfAbsent(paramString, localCipherSuite1);
      if (localCipherSuite2 == null)
        localObject = localCipherSuite1;
    }
    else
    {
      return localObject;
    }
    return (CipherSuite)localCipherSuite2;
  }
