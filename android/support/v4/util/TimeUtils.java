...
public final class TimeUtils
{
  ...
  private static int formatDurationLocked(long paramLong, int paramInt)
  {
    ...
    label313: label319: label325: label331: for (int i21 = 3; ; i21 = 0)
    {
    ...
    label337: arrayOfChar[i5] = i;
    int i6 = i5 + 1;
    int i7;
    boolean bool1;
    label380: int i9;
    label388: boolean bool2;
    label414: int i11;
    label422: boolean bool3;
    label448: int i13;
    label456: int i14;
    if (paramInt != 0)
    {
    ...
    label519: label525: label531: label537: label543: label549: label555: for (int i15 = 3; ; i15 = 0)
    {
