    ...
    throws IOException, XmlPullParserException
  {
    ...
    while (true)
    {
      ...
      while (true)
      {
        ...
        {
          File[] arrayOfFile2 = ContextCompat.getExternalFilesDirs(paramContext, null);
        ...
        boolean bool = "external-cache-path".equals(str1);
        localFile = null;
        if (!bool)
          continue;
        File[] arrayOfFile1 = ContextCompat.getExternalCacheDirs(paramContext);
