    ...
    implements GestureDetectorCompat.GestureDetectorCompatImpl
  {
    ...
    public boolean onTouchEvent(MotionEvent paramMotionEvent)
    {
      ...
      case 2:
          ...
          do
          {
            ...
            do
            {
              ...
              do
              {
                ...
                i8 = paramMotionEvent.getActionIndex();
                int i9 = paramMotionEvent.getPointerId(i8);
                f9 = this.mVelocityTracker.getXVelocity(i9);
                f10 = this.mVelocityTracker.getYVelocity(i9);
                i10 = 0;
                i11 = i10;
                bool1 = false;
              }
              ...
              do
              {
                i10++;
                break;
                i12 = paramMotionEvent.getPointerId(i10);
              }
              while (f9 * this.mVelocityTracker.getXVelocity(i12) + f10 * this.mVelocityTracker.getYVelocity(i12) >= 0.0F);
        ...
        return bool5;
      case 1:
        label644: label849: label876: this.mStillDown = false;
        ...
        while (true)
        {
          ...
          float f5 = localVelocityTracker.getYVelocity(i3);
          float f6 = localVelocityTracker.getXVelocity(i3);
