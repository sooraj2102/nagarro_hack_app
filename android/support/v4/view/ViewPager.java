...
public class ViewPager extends ViewGroup
{
  ...
  private boolean performDrag(float paramFloat)
  {
    ...
    if (f2 < f3)
    {
      ...
      {
        float f5 = f3 - f2;
        this.mLeftEdge.onPull(Math.abs(f5) / i);
        m = 1;
      }
      f2 = f3;
    }
    while (true)
    {
      ...
      {
        float f6 = f2 - f4;
        this.mRightEdge.onPull(Math.abs(f6) / i);
        m = 1;
      }
      f2 = f4;
    }
  ...
  protected void onDraw(Canvas paramCanvas)
  {
    ...
    for (int i2 = n; ; i2++)
    {
      ...
      while (true)
      {
        ...
        {
          this.mMarginDrawable.setBounds(Math.round(f4), this.mTopPageBounds, Math.round(f4 + this.mPageMargin), this.mBottomPageBounds);
    ...
    while (true)
    {
      ...
      if (i1 < i2)
      {
        ...
        if (localItemInfo8.position < this.mCurItem)
          break label650;
        int i21 = localItemInfo8.position;
        int i22 = this.mCurItem;
        localObject1 = null;
        if (i21 == i22)
      ...
      label1008: label1141: for (Object localObject2 = ((ItemInfo)localObject1).object; ; localObject2 = null)
      {
        ...
        for (localItemInfo5 = (ItemInfo)this.mItems.get(i7); ; localItemInfo5 = null)
          break;
        label889: localItemInfo6 = null;
        break label458;
        label895: f4 = 2.0F + getPaddingRight() / i8;
        break label466;
  ...
  public void setPageTransformer(boolean paramBoolean, PageTransformer paramPageTransformer, int paramInt)
  {
    ...
    if (paramPageTransformer != null)
    {
      ...
      if (j == m)
        break label89;
      i1 = i;
      label33: this.mPageTransformer = paramPageTransformer;
  ...
  void smoothScrollTo(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    while (true)
    {
      ...
      i = 0;
      break;
      label115: j = this.mScroller.getStartX();
      break label54;
      label127: j = getScrollX();
    }
