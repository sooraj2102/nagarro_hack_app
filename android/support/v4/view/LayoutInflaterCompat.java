...
public final class LayoutInflaterCompat
{
  ...
  static class LayoutInflaterCompatApi21Impl extends LayoutInflaterCompat.LayoutInflaterCompatBaseImpl
  {
    public void setFactory(LayoutInflater paramLayoutInflater, LayoutInflaterFactory paramLayoutInflaterFactory)
    {
      ...
      for (LayoutInflaterCompat.Factory2Wrapper localFactory2Wrapper = new LayoutInflaterCompat.Factory2Wrapper(paramLayoutInflaterFactory); ; localFactory2Wrapper = null)
      {
        paramLayoutInflater.setFactory2(localFactory2Wrapper);
        return;
      }
    }
  ...
  static class LayoutInflaterCompatBaseImpl
  {
    public LayoutInflaterFactory getFactory(LayoutInflater paramLayoutInflater)
    {
      ...
      if ((localFactory instanceof LayoutInflaterCompat.Factory2Wrapper))
        return ((LayoutInflaterCompat.Factory2Wrapper)localFactory).mDelegateFactory;
      return null;
    }
    ...
    public void setFactory(LayoutInflater paramLayoutInflater, LayoutInflaterFactory paramLayoutInflaterFactory)
    {
      ...
      for (LayoutInflaterCompat.Factory2Wrapper localFactory2Wrapper = new LayoutInflaterCompat.Factory2Wrapper(paramLayoutInflaterFactory); ; localFactory2Wrapper = null)
      {
        setFactory2(paramLayoutInflater, localFactory2Wrapper);
        return;
      }
    }
