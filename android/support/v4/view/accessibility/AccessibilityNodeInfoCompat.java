...
import java.util.List<Landroid.support.v4.view.accessibility.AccessibilityNodeInfoCompat;>;
...
public class AccessibilityNodeInfoCompat
{
  ...
  {
    List localList = IMPL.findAccessibilityNodeInfosByViewId(this.mInfo, paramString);
    if (localList != null)
    {
      localObject = new ArrayList();
      Iterator localIterator = localList.iterator();
      while (localIterator.hasNext())
        ((List)localObject).add(wrap((AccessibilityNodeInfo)localIterator.next()));
    }
    Object localObject = Collections.emptyList();
    return (List<AccessibilityNodeInfoCompat>)localObject;
  }
