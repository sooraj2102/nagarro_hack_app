  ...
  implements Animatable
{
  ...
  private void setupAnimators()
  {
    ...
    localValueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(localRing)
    {
    ...
    localValueAnimator.addListener(new Animator.AnimatorListener(localRing)
    {
      ...
      public void onAnimationRepeat(Animator paramAnimator)
      {
        ...
        CircularProgressDrawable.access$202(CircularProgressDrawable.this, 1.0F + CircularProgressDrawable.this.mRotationCount);
      }
