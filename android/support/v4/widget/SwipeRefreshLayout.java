  ...
  implements NestedScrollingParent, NestedScrollingChild
{
  ...
  private final Animation mAnimateToCorrectPosition = new Animation()
  {
    public void applyTransformation(float paramFloat, Transformation paramTransformation)
    {
      ...
      {
        int j = SwipeRefreshLayout.this.mFrom + (int)(paramFloat * (i - SwipeRefreshLayout.this.mFrom)) - SwipeRefreshLayout.this.mCircleView.getTop();
  ...
  private void moveSpinner(float paramFloat)
  {
    ...
    {
      f4 = this.mSpinnerOffsetEnd - this.mOriginalOffsetTop;
    ...
    while (true)
    {
      ...
      return;
      f4 = this.mSpinnerOffsetEnd;
      break;
      label321: if ((this.mProgress.getAlpha() >= 255) || (isAnimationRunning(this.mAlphaMaxAnimation)))
        continue;
  ...
  private void startScaleDownReturnToStartAnimation(int paramInt, Animation.AnimationListener paramAnimationListener)
  {
    ...
    this.mScaleDownToStartAnimation = new Animation()
    {
      public void applyTransformation(float paramFloat, Transformation paramTransformation)
      {
        float f = SwipeRefreshLayout.this.mStartingScale + paramFloat * -SwipeRefreshLayout.this.mStartingScale;
