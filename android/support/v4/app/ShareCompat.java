...
public final class ShareCompat
{
  ...
  public static void configureMenuItem(MenuItem paramMenuItem, IntentBuilder paramIntentBuilder)
  {
    ...
    for (ShareActionProvider localShareActionProvider = new ShareActionProvider(paramIntentBuilder.getActivity()); ; localShareActionProvider = (ShareActionProvider)localActionProvider)
    {
      localShareActionProvider.setShareHistoryFileName(".sharecompat_" + paramIntentBuilder.getActivity().getClass().getName());
      localShareActionProvider.setShareIntent(paramIntentBuilder.getIntent());
  ...
  public static class IntentReader
  {
    ...
    public String getHtmlText()
    {
      ...
      withinStyle(localStringBuilder, localCharSequence, 0, localCharSequence.length());
