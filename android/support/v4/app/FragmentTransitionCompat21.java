...
class FragmentTransitionCompat21
{
  ...
  public static void setNameOverridesOrdered(View paramView, ArrayList<View> paramArrayList, Map<String, String> paramMap)
  {
  ...
  public static void setNameOverridesReordered(View paramView, ArrayList<View> paramArrayList1, ArrayList<View> paramArrayList2, ArrayList<String> paramArrayList, Map<String, String> paramMap)
  {
