...
public final class RemoteInput extends RemoteInputCompatBase.RemoteInput
{
  ...
  static
  {
    ...
    while (true)
    {
      ...
      {
        public RemoteInput build(String paramString, CharSequence paramCharSequence, CharSequence[] paramArrayOfCharSequence, boolean paramBoolean, Bundle paramBundle, Set<String> paramSet)
        {
          return new RemoteInput(paramString, paramCharSequence, paramArrayOfCharSequence, paramBoolean, paramBundle, paramSet);
        }
