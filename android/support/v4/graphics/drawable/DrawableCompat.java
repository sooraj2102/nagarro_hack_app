...
public final class DrawableCompat
{
  ...
  static class DrawableCompatApi17Impl extends DrawableCompat.DrawableCompatBaseImpl
  {
    ...
    public int getLayoutDirection(Drawable paramDrawable)
    {
      ...
      catch (NoSuchMethodException localNoSuchMethodException)
      {
        ...
        {
          Log.i("DrawableCompatApi17", "Failed to invoke getLayoutDirection() via reflection", localException);
    ...
    public boolean setLayoutDirection(Drawable paramDrawable, int paramInt)
    {
      ...
      catch (NoSuchMethodException localNoSuchMethodException)
      {
        ...
        {
          Log.i("DrawableCompatApi17", "Failed to invoke setLayoutDirection(int) via reflection", localException);
  ...
  static class DrawableCompatApi19Impl extends DrawableCompat.DrawableCompatApi17Impl
  {
    ...
    public Drawable wrap(Drawable paramDrawable)
    {
      if (!(paramDrawable instanceof TintAwareDrawable))
        paramDrawable = new DrawableWrapperApi19(paramDrawable);
      return paramDrawable;
    }
  }
  ...
  static class DrawableCompatApi21Impl extends DrawableCompat.DrawableCompatApi19Impl
  {
    ...
    {
      if (!(paramDrawable instanceof TintAwareDrawable))
        paramDrawable = new DrawableWrapperApi21(paramDrawable);
      return paramDrawable;
    }
  }
  ...
  static class DrawableCompatBaseImpl
  {
    ...
    {
      if (!(paramDrawable instanceof TintAwareDrawable))
        paramDrawable = new DrawableWrapperApi14(paramDrawable);
      return paramDrawable;
    }
  }
}
