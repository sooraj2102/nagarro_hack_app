...
public abstract class RoundedBitmapDrawable extends Drawable
{
  ...
  void updateDstRect()
  {
    if (this.mApplyGravity)
    {
      ...
      int m = Math.max(0, (this.mDstRect.height() - j) / 2);
      this.mDstRect.inset(k, m);
    ...
    while (true)
    {
      ...
      return;
      label228: gravityCompatApply(this.mGravity, this.mBitmapWidth, this.mBitmapHeight, getBounds(), this.mDstRect);
    }
  }
}
