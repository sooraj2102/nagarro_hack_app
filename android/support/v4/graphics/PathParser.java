  ...
  private static float[] getFloats(String paramString)
  {
    ...
    while (true)
    {
      ...
      try
      {
        ...
        {
          n = k + 1;
          arrayOfFloat1[k] = Float.parseFloat(paramString.substring(i, m));
  ...
  public static class PathDataNode
  {
    ...
    private static void addCommand(Path paramPath, float[] paramArrayOfFloat1, char paramChar1, char paramChar2, float[] paramArrayOfFloat2)
    {
      ...
      case 'a':
        while (true)
        {
          label207: paramChar1 = paramChar2;
          j += i;
          break label207;
          paramPath.close();
          f1 = f5;
        ...
        {
          bool3 = true;
          label1670: if (paramArrayOfFloat2[(j + 4)] == 0.0F)
            break label1749;
        }
        label1749: for (boolean bool4 = true; ; bool4 = false)
        {
        ...
        {
          bool1 = true;
          label1816: if (paramArrayOfFloat2[(j + 4)] == 0.0F)
            break label1889;
        }
        label1889: for (boolean bool2 = true; ; bool2 = false)
        {
    ...
    private static void drawArc(Path paramPath, float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, float paramFloat5, float paramFloat6, float paramFloat7, boolean paramBoolean1, boolean paramBoolean2)
    {
      ...
      while (true)
      {
        ...
        label423: bool = false;
        break label325;
        label429: d20 += 6.283185307179586D;
      }
    }
