    ...
    implements MediaBrowserCompat.MediaBrowserImpl, MediaBrowserCompat.MediaBrowserServiceCallbackImpl, MediaBrowserCompat.ConnectionCallback.ConnectionCallbackInternal
  {
    ...
    public void onLoadChildren(Messenger paramMessenger, String paramString, List paramList, Bundle paramBundle)
    {
      ...
      do
      {
        ...
        localSubscriptionCallback = localSubscription.getCallback(this.mContext, paramBundle);
      }
    ...
    public void search(@NonNull String paramString, Bundle paramBundle, @NonNull MediaBrowserCompat.SearchCallback paramSearchCallback)
    {
      if (!isConnected())
      ...
      if (this.mServiceBinderWrapper == null)
      {
        ...
        this.mHandler.post(new Runnable(paramSearchCallback, paramString, paramBundle)
        {
          public void run()
          {
    ...
    public void sendCustomAction(@NonNull String paramString, Bundle paramBundle, @Nullable MediaBrowserCompat.CustomActionCallback paramCustomActionCallback)
    {
      if (!isConnected())
      ...
      if (this.mServiceBinderWrapper == null)
      {
        ...
        if (paramCustomActionCallback != null)
          this.mHandler.post(new Runnable(paramCustomActionCallback, paramString, paramBundle)
          {
            public void run()
            {
    ...
    public void subscribe(@NonNull String paramString, Bundle paramBundle, @NonNull MediaBrowserCompat.SubscriptionCallback paramSubscriptionCallback)
    {
      ...
      {
        localSubscription.putCallback(this.mContext, localBundle, paramSubscriptionCallback);
        if (this.mServiceBinderWrapper != null)
          break;
      ...
      try
      {
        this.mServiceBinderWrapper.addSubscription(paramString, MediaBrowserCompat.SubscriptionCallback.access$000(paramSubscriptionCallback), localBundle, this.mCallbacksMessenger);
        return;
      }
      catch (RemoteException localRemoteException)
      {
