  ...
  public static MediaDescriptionCompat fromMediaDescription(Object paramObject)
  {
    ...
    if (paramObject != null)
    {
      ...
      if (i >= 21)
      {
        ...
        label121: localBuilder.setExtras(localBundle);
        if (localUri == null)
          break label184;
    ...
    while (true)
    {
      localMediaDescriptionCompat = localBuilder.build();
      localMediaDescriptionCompat.mDescriptionObj = paramObject;
      return localMediaDescriptionCompat;
      label152: localUri = (Uri)localBundle.getParcelable("android.support.v4.media.description.MEDIA_URI");
      break;
      label167: localBundle.remove("android.support.v4.media.description.MEDIA_URI");
      localBundle.remove("android.support.v4.media.description.NULL_BUNDLE_FLAG");
      break label121;
      label184: if (Build.VERSION.SDK_INT < 23)
        continue;
