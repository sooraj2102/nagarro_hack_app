...
public final class MediaControllerCompat
{
  ...
  public static MediaControllerCompat getMediaController(@NonNull Activity paramActivity)
  {
    ...
    if ((paramActivity instanceof SupportActivity))
    {
      ...
      if (localMediaControllerExtraData != null)
        localMediaControllerCompat1 = localMediaControllerExtraData.getMediaController();
    }
    Object localObject1;
    do
    {
      ...
      if (this.mExtraBinder != null)
        try
        {
          ...
          if (localExtraCallback != null)
            this.mExtraBinder.unregisterCallbackListener(localExtraCallback);
          return;
        }
        catch (RemoteException localRemoteException)
        {
  ...
  static class TransportControlsApi21 extends MediaControllerCompat.TransportControls
  {
    ...
    {
      MediaControllerCompat.access$100(paramCustomAction.getAction(), paramBundle);
    ...
    {
      MediaControllerCompat.access$100(paramString, paramBundle);
