  ...
  public CharSequence unicodeWrap(CharSequence paramCharSequence, TextDirectionHeuristicCompat paramTextDirectionHeuristicCompat, boolean paramBoolean)
  {
    ...
    if ((getStereoReset()) && (paramBoolean))
    {
      if (bool)
      {
        ...
        label56: localSpannableStringBuilder.append(markBefore(paramCharSequence, localTextDirectionHeuristicCompat2));
      }
    }
    else
    {
      ...
      if (!bool)
        break label150;
      int i = 8235;
      label88: localSpannableStringBuilder.append(i);
    ...
    label150: label158: label166: label168: for (TextDirectionHeuristicCompat localTextDirectionHeuristicCompat1 = TextDirectionHeuristicsCompat.RTL; ; localTextDirectionHeuristicCompat1 = TextDirectionHeuristicsCompat.LTR)
    {
