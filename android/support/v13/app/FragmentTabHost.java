  ...
  implements TabHost.OnTabChangeListener
{
  ...
  private FragmentTransaction doTabChanged(String paramString, FragmentTransaction paramFragmentTransaction)
  {
    ...
    if (this.mLastTab != localObject)
    {
      ...
      if (localObject != null)
      {
        if (localObject.fragment != null)
          break label189;
        localObject.fragment = Fragment.instantiate(this.mContext, localObject.clss.getName(), localObject.args);
    ...
    while (true)
    {
      ...
      label189: paramFragmentTransaction.attach(localObject.fragment);
    }
  }
  ...
  protected void onAttachedToWindow()
  {
    ...
    if (i < this.mTabs.size())
    {
      ...
      while (true)
      {
        i++;
        break;
        label97: if (localFragmentTransaction1 == null)
