...
public class TextInputLayout extends LinearLayout
{
  ...
  private void passwordVisibilityToggleRequested(boolean paramBoolean)
  {
    ...
    for (this.mPasswordToggledVisible = true; ; this.mPasswordToggledVisible = false)
    {
      ...
      return;
      label66: this.mEditText.setTransformationMethod(PasswordTransformationMethod.getInstance());
    }
  }
  ...
  private void setError(@Nullable CharSequence paramCharSequence, boolean paramBoolean)
  {
    ...
    while (true)
    {
      ...
      bool = false;
      break;
      label148: this.mErrorView.setAlpha(1.0F);
      continue;
      label159: if (this.mErrorView.getVisibility() != 0)
        continue;
      if (paramBoolean)
      {
        this.mErrorView.animate().alpha(0.0F).setDuration(200L).setInterpolator(AnimationUtils.FAST_OUT_LINEAR_IN_INTERPOLATOR).setListener(new AnimatorListenerAdapter(paramCharSequence)
        {
  ...
  void animateToExpansionFraction(float paramFloat)
  {
    ...
    if (this.mAnimator == null)
    {
      ...
      this.mAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener()
      {
        ...
        {
          TextInputLayout.this.mCollapsingTextHelper.setExpansionFraction(((Float)paramValueAnimator.getAnimatedValue()).floatValue());
        }
      });
    }
    ValueAnimator localValueAnimator = this.mAnimator;
    float[] arrayOfFloat = new float[2];
    arrayOfFloat[0] = this.mCollapsingTextHelper.getExpansionFraction();
  ...
  public void setCounterEnabled(boolean paramBoolean)
  {
    ...
    while (true)
    {
      ...
      label151: removeIndicator(this.mCounterView);
  ...
  public void setCounterMaxLength(int paramInt)
  {
    ...
    label39: label47: for (int i = 0; ; i = this.mEditText.getText().length())
    {
      updateCounter(i);
      return;
  ...
  public void setErrorEnabled(boolean paramBoolean)
  {
    ...
    while (true)
    {
      try
      {
        ...
        this.mErrorView.setTextColor(ContextCompat.getColor(getContext(), R.color.error_color_material));
        this.mErrorView.setVisibility(4);
      ...
      label189: this.mErrorShown = false;
      updateEditTextBackground();
  ...
  void updateCounter(int paramInt)
  {
    ...
    boolean bool2;
    label64: TextView localTextView2;
    ...
    label167: for (int j = this.mCounterOverflowTextAppearance; ; j = this.mCounterTextAppearance)
    {
  ...
  void updateLabelState(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if ((this.mEditText != null) && (!TextUtils.isEmpty(this.mEditText.getText())))
    {
      ...
      if (TextUtils.isEmpty(getError()))
        break label148;
      j = 1;
      label53: if (this.mDefaultTextColor != null)
      ...
      label103: if ((i == 0) && ((!isEnabled()) || ((!bool2) && (j == 0))))
        break label205;
      if ((paramBoolean2) || (this.mHintExpanded))
        collapseHint(paramBoolean1);
    }
    label148: label154: label205: 
    do
    {
      return;
      i = 0;
