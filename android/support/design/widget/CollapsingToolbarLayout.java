...
public class CollapsingToolbarLayout extends FrameLayout
{
  ...
  public CollapsingToolbarLayout(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    ViewCompat.setOnApplyWindowInsetsListener(this, new OnApplyWindowInsetsListener()
    {
      ...
      {
        return CollapsingToolbarLayout.this.onWindowInsetChanged(paramWindowInsetsCompat);
      }
    });
  }
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    label156: int i1;
    label205: int i5;
    label255: CollapsingTextHelper localCollapsingTextHelper2;
    int i6;
    label304: int i7;
    int i8;
    if ((this.mCollapsingTitleEnabled) && (this.mDummyView != null))
    ...
    label399: label405: label411: label420: label432: label444: label453: for (int i9 = this.mExpandedMarginStart; ; i9 = this.mExpandedMarginEnd)
    {
    ...
    while (true)
    {
      ...
      return;
      label534: setMinimumHeight(getHeightWithMargins(this.mToolbarDirectChild));
    }
  }
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    if (this.mLastInsets != null);
    for (int j = this.mLastInsets.getSystemWindowInsetTop(); ; j = 0)
    {
      if ((i == 0) && (j > 0))
