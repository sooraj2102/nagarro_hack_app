  ...
  implements NestedScrollingParent2
{
  ...
  static
  {
    ...
    while (true)
    {
      ...
      str = null;
      break;
      label82: TOP_SORTED_CHILDREN_COMPARATOR = null;
    }
  }
  ...
  public CoordinatorLayout(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    if (i != 0)
    {
      ...
      for (int k = 0; k < j; k++)
        this.mKeylines[k] = (int)(f * this.mKeylines[k]);
    }
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    while (true)
    {
      ...
      i9 = Math.max(i9, i22);
      i10 = View.combineMeasuredStates(i10, localView.getMeasuredState());
      break;
      label475: if ((i26 != 5) || (i1 != 0))
      {
        i18 = 0;
        if (i26 != 3)
          continue;
    ...
    label516: int i14 = 0xFF000000 & i10;
    int i15 = View.resolveSizeAndState(i8, paramInt1, i14);
    int i16 = i10 << 16;
    setMeasuredDimension(i15, View.resolveSizeAndState(i9, paramInt2, i16));
  }
  ...
  public void onNestedPreScroll(View paramView, int paramInt1, int paramInt2, int[] paramArrayOfInt, int paramInt3)
  {
    ...
    if (n < m)
    {
      ...
      do
      {
        ...
        while (!localLayoutParams.isNestedScrollAccepted(paramInt3));
        localBehavior = localLayoutParams.getBehavior();
      }
      ...
      if (paramInt1 > 0)
      {
        ...
        label133: if (paramInt2 <= 0)
          break label172;
      }
      label172: for (j = Math.max(j, this.mTempIntPair[1]); ; j = Math.min(j, this.mTempIntPair[1]))
      {
        k = 1;
        break;
