...
public class TabLayout extends HorizontalScrollView
{
  ...
  private int calculateScrollXForTab(int paramInt, float paramFloat)
  {
    if (this.mMode == 0)
    {
      ...
      int k;
      int m;
      label118: for (int i = localView1.getWidth(); ; i = 0)
      {
        int j = 0;
        if (localView2 != null)
  ...
  public void removeTabAt(int paramInt)
  {
    ...
    if (i == paramInt)
      if (!this.mTabs.isEmpty())
        break label122;
    label122: for (Tab localTab2 = null; ; localTab2 = (Tab)this.mTabs.get(Math.max(0, paramInt - 1)))
    {
      selectTab(localTab2);
      return;
    }
  ...
  private class SlidingTabStrip extends LinearLayout
  {
    ...
    void animateIndicatorToPosition(int paramInt1, int paramInt2)
    {
      ...
      while (true)
      {
        ...
        i = 0;
        break;
        label56: int j = localView.getLeft();
        ...
        while ((i1 != j) || (n != k))
        {
          ...
          localValueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(i1, j, n, k)
          {
            public void onAnimationUpdate(ValueAnimator paramValueAnimator)
            {
          ...
          localValueAnimator.addListener(new AnimatorListenerAdapter(paramInt1)
          {
            public void onAnimationEnd(Animator paramAnimator)
            {
              TabLayout.SlidingTabStrip.this.mSelectedPosition = this.val$position;
  ...
  class TabView extends LinearLayout
  {
    ...
    public TabView(Context arg2)
    {
      ...
      if (TabLayout.this.mTabBackgroundResId != 0)
        ViewCompat.setBackground(this, AppCompatResources.getDrawable(localContext, TabLayout.this.mTabBackgroundResId));
    ...
    private void updateTextAndIcon(@Nullable TextView paramTextView, @Nullable ImageView paramImageView)
    {
      ...
      label31: CharSequence localCharSequence2;
      label47: label70: int i;
      label87: label112: CharSequence localCharSequence3;
      if (this.mTab != null)
      {
      ...
      while (true)
      {
        ...
        localDrawable = null;
        break;
        label205: localCharSequence1 = null;
        break label31;
        label211: localCharSequence2 = null;
        break label47;
        label217: paramImageView.setVisibility(8);
        paramImageView.setImageDrawable(null);
        break label70;
        label231: i = 0;
        break label87;
        label237: paramTextView.setVisibility(8);
        paramTextView.setText(null);
        break label112;
        label251: localCharSequence3 = localCharSequence2;
      }
    }
    ...
    public void onMeasure(int paramInt1, int paramInt2)
    {
      ...
      if ((k > 0) && ((j == 0) || (i > k)))
      {
        m = View.MeasureSpec.makeMeasureSpec(TabLayout.this.mTabMaxWidth, -2147483648);
      ...
      while (true)
      {
        ...
        m = paramInt1;
        break;
        label262: if ((this.mTextView == null) || (this.mTextView.getLineCount() <= 1))
          continue;
    ...
    final void update()
    {
      ...
      if (localTab != null)
      {
        ...
        label140: if (this.mCustomView != null)
          break label344;
        if (this.mIconView == null)
        {
        ...
        label287: if ((localTab == null) || (!localTab.isSelected()))
          break label373;
      }
      label311: label344: label373: for (boolean bool = true; ; bool = false)
      {
        setSelected(bool);
        return;
        localView = null;
