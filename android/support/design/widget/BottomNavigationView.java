...
public class BottomNavigationView extends FrameLayout
{
  ...
  public BottomNavigationView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    TintTypedArray localTintTypedArray = TintTypedArray.obtainStyledAttributes(paramContext, paramAttributeSet, R.styleable.BottomNavigationView, paramInt, R.style.Widget_Design_BottomNavigationView);
    if (localTintTypedArray.hasValue(R.styleable.BottomNavigationView_itemIconTint))
    {
      this.mMenuView.setIconTintList(localTintTypedArray.getColorStateList(R.styleable.BottomNavigationView_itemIconTint));
      if (!localTintTypedArray.hasValue(R.styleable.BottomNavigationView_itemTextColor))
        break label326;
      this.mMenuView.setItemTextColor(localTintTypedArray.getColorStateList(R.styleable.BottomNavigationView_itemTextColor));
    }
    while (true)
    {
      ...
      int i = localTintTypedArray.getResourceId(R.styleable.BottomNavigationView_itemBackground, 0);
      ...
      this.mMenu.setCallback(new MenuBuilder.Callback()
      {
        ...
        {
          if ((BottomNavigationView.this.mReselectedListener != null) && (paramMenuItem.getItemId() == BottomNavigationView.this.getSelectedItemId()))
            BottomNavigationView.this.mReselectedListener.onNavigationItemReselected(paramMenuItem);
          do
            return true;
          while ((BottomNavigationView.this.mSelectedListener != null) && (!BottomNavigationView.this.mSelectedListener.onNavigationItemSelected(paramMenuItem)));
          return false;
        }
      ...
      break;
      label326: this.mMenuView.setItemTextColor(createDefaultColorStateList(16842808));
    }
  }
  ...
  protected void onRestoreInstanceState(Parcelable paramParcelable)
  {
    ...
    this.mMenu.restorePresenterStates(localSavedState.menuPresenterState);
  }
