...
final class CollapsingTextHelper
{
    ...
    if (this.mTextToDraw != null)
    {
      ...
      default:
        ...
        default:
          ...
          label180: calculateUsingTextSize(this.mExpandedTextSize);
          if (this.mTextToDraw != null)
          {
            f3 = this.mTextPaint.measureText(this.mTextToDraw, 0, this.mTextToDraw.length());
            label218: int n = this.mExpandedTextGravity;
            if (!this.mIsRtl)
              break label453;
            label231: int i1 = GravityCompat.getAbsoluteGravity(n, i);
            switch (i1 & 0x70)
            {
            default:
  ...
  private void calculateUsingTextSize(float paramFloat)
  {
    ...
    int i;
    float f5;
    label87: label119: TextPaint localTextPaint;
    while (true)
    {
      return;
      ...
      this.mScale = 1.0F;
      boolean bool3 = areTypefacesDifferent(this.mCurrentTypeface, this.mCollapsedTypeface);
      i = 0;
      if (bool3)
      {
    ...
    while (true)
    {
      ...
      boolean bool2 = areTypefacesDifferent(this.mCurrentTypeface, this.mExpandedTypeface);
      i = 0;
      if (bool2)
      {
  ...
  public void draw(Canvas paramCanvas)
  {
    ...
    while (true)
    {
      ...
      label135: j = 0;
      break;
      label141: f3 = this.mTextPaint.ascent() * this.mScale;
      (this.mTextPaint.descent() * this.mScale);
      break label73;
      label171: paramCanvas.drawText(this.mTextToDraw, 0, this.mTextToDraw.length(), f1, f2, this.mTextPaint);
    }
  }
