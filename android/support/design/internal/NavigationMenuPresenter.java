  ...
  implements MenuPresenter
{
  ...
  final View.OnClickListener mOnClickListener = new View.OnClickListener()
  {
    ...
    {
      NavigationMenuItemView localNavigationMenuItemView = (NavigationMenuItemView)paramView;
  ...
  private class NavigationMenuAdapter extends RecyclerView.Adapter<NavigationMenuPresenter.ViewHolder>
  {
    ...
    public Bundle createInstanceState()
    {
      ...
      if (i < j)
      {
        ...
        label134: for (View localView = localMenuItemImpl.getActionView(); ; localView = null)
        {
          if (localView != null)
          {
    ...
    public void restoreInstanceState(Bundle paramBundle)
    {
      ...
      int j;
      label120: NavigationMenuPresenter.NavigationMenuItem localNavigationMenuItem1;
      if (i != 0)
      {
        this.mUpdateSuspended = true;
        m = 0;
      ...
      while (true)
      {
        ...
        m++;
        break;
        label161: MenuItemImpl localMenuItemImpl1 = ((NavigationMenuPresenter.NavigationMenuTextItem)localNavigationMenuItem1).getMenuItem();
