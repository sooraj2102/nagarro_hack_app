...
public class ConstraintSet
{
  ...
  private void createHorizontalChain(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int[] paramArrayOfInt, float[] paramArrayOfFloat, int paramInt5, int paramInt6, int paramInt7)
  {
    ...
    {
      paramArrayOfInt[i];
      connect(paramArrayOfInt[i], paramInt6, paramArrayOfInt[(i - 1)], paramInt7, -1);
      connect(paramArrayOfInt[(i - 1)], paramInt7, paramArrayOfInt[i], paramInt6, -1);
      if (paramArrayOfFloat == null)
        continue;
      get(paramArrayOfInt[i]).horizontalWeight = paramArrayOfFloat[i];
    }
    connect(paramArrayOfInt[(-1 + paramArrayOfInt.length)], paramInt7, paramInt3, paramInt4, -1);
  }
  ...
  public void addToHorizontalChain(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    label67: for (int j = 2; ; j = 1)
    {
      connect(paramInt1, 2, paramInt3, j, 0);
      if (paramInt2 != 0)
  ...
  public void addToHorizontalChainRTL(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    label76: for (int j = 7; ; j = 6)
    {
      connect(paramInt1, 7, paramInt3, j, 0);
      if (paramInt2 != 0)
  ...
  public void addToVerticalChain(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    label67: for (int j = 4; ; j = 3)
    {
      connect(paramInt1, 4, paramInt3, j, 0);
      if (paramInt2 != 0)
  ...
  void applyToInternal(ConstraintLayout paramConstraintLayout)
  {
    ...
    HashSet localHashSet = new HashSet(this.mConstraints.keySet());
    for (int j = 0; j < i; j++)
    {
      ...
      Constraint localConstraint2 = (Constraint)this.mConstraints.get(Integer.valueOf(k));
      ...
      localView.setVisibility(localConstraint2.visibility);
      if (Build.VERSION.SDK_INT < 17)
        continue;
      localView.setAlpha(localConstraint2.alpha);
      localView.setRotationX(localConstraint2.rotationX);
      localView.setRotationY(localConstraint2.rotationY);
      localView.setScaleX(localConstraint2.scaleX);
      localView.setScaleY(localConstraint2.scaleY);
      localView.setPivotX(localConstraint2.transformPivotX);
      localView.setPivotY(localConstraint2.transformPivotY);
      localView.setTranslationX(localConstraint2.translationX);
      localView.setTranslationY(localConstraint2.translationY);
      if (Build.VERSION.SDK_INT < 21)
        continue;
      localView.setTranslationZ(localConstraint2.translationZ);
      if (!localConstraint2.applyElevation)
        continue;
      localView.setElevation(localConstraint2.elevation);
    }
    Iterator localIterator = localHashSet.iterator();
    while (localIterator.hasNext())
    {
      Integer localInteger = (Integer)localIterator.next();
      Constraint localConstraint1 = (Constraint)this.mConstraints.get(localInteger);
      if (!localConstraint1.mIsGuideline)
        continue;
  ...
  public void createVerticalChain(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int[] paramArrayOfInt, float[] paramArrayOfFloat, int paramInt5)
  {
    ...
    for (int i = 1; i < paramArrayOfInt.length; i++)
    {
      ...
      if (paramArrayOfFloat == null)
        continue;
      get(paramArrayOfInt[i]).verticalWeight = paramArrayOfFloat[i];
    }
    connect(paramArrayOfInt[(-1 + paramArrayOfInt.length)], 4, paramInt3, paramInt4, 0);
  }
  ...
  public void removeFromHorizontalChain(int paramInt)
  {
    ...
    while (true)
    {
      ...
      if (localConstraint.leftToLeft == -1)
        continue;
      connect(j, 1, localConstraint.leftToLeft, 1, 0);
    }
    label153: int k = localConstraint.startToEnd;
    int m = localConstraint.endToStart;
    if ((k != -1) || (m != -1))
    {
      if ((k == -1) || (m == -1))
        break label229;
    ...
    while (true)
    {
      ...
      if (localConstraint.leftToLeft == -1)
        continue;
      connect(m, 6, localConstraint.leftToLeft, 6, 0);
    }
  }
