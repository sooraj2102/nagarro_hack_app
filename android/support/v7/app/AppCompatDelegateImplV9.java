  ...
  implements MenuBuilder.Callback, LayoutInflater.Factory2
{
  ...
  private ViewGroup createSubDecor()
  {
    ...
    while (true)
    {
      ...
      break;
      label273: boolean bool = this.mHasActionBar;
      ...
      label448: if (this.mOverlayActionMode);
      ...
      label510: ((FitWindowsViewGroup)localViewGroup1).setOnFitSystemWindowsListener(new FitWindowsViewGroup.OnFitSystemWindowsListener()
      {
    ...
    label531: if (this.mDecorContentParent == null)
    ...
    return (ViewGroup)localViewGroup1;
  }
  ...
  private boolean onKeyUpPanel(int paramInt, KeyEvent paramKeyEvent)
  {
    ...
    label243: Log.w("AppCompatDelegate", "Couldn't get audio manager");
    return bool1;
  }
  ...
  private void openPanel(PanelFeatureState paramPanelFeatureState, KeyEvent paramKeyEvent)
  {
    ...
    while (true)
    {
      ...
      if (paramPanelFeatureState.decorView == null)
      {
        if ((!initializePanelDecor(paramPanelFeatureState)) || (paramPanelFeatureState.decorView == null))
          continue;
        label189: if ((!initializePanelContent(paramPanelFeatureState)) || (!paramPanelFeatureState.hasPanelItems()))
          break label407;
    ...
    while (true)
    {
      ...
      break label189;
      label407: break;
      label409: if (paramPanelFeatureState.createdPanelView == null)
        continue;
  ...
  private boolean preparePanel(PanelFeatureState paramPanelFeatureState, KeyEvent paramKeyEvent)
  {
    ...
    label274: paramPanelFeatureState.refreshMenuContent = false;
    label279: paramPanelFeatureState.menu.stopDispatchingItemsChanged();
  ...
  public View createView(View paramView, String paramString, @NonNull Context paramContext, @NonNull AttributeSet paramAttributeSet)
  {
    ...
    while (true)
    {
      ...
      label78: bool2 = false;
      continue;
      label84: bool2 = shouldInheritContext((ViewParent)paramView);
    }
  }
  ...
  protected PanelFeatureState getPanelState(int paramInt, boolean paramBoolean)
  {
    ...
    return (PanelFeatureState)localPanelFeatureState;
  }
  ...
  ActionMode startSupportActionModeFromWindow(@NonNull ActionMode.Callback paramCallback)
  {
    ...
    try
    {
      ...
      while (true)
      {
        ...
        {
          label341: if (this.mActionModeView == null)
            break label561;
          endOnGoingFadeAnimation();
          ...
          if (this.mActionModePopup != null)
            break label563;
          bool1 = true;
          label384: StandaloneActionMode localStandaloneActionMode = new StandaloneActionMode(localContext, localActionBarContextView, paramCallback, bool1);
        ...
        while (true)
        {
          ...
          break label221;
          label516: ViewStubCompat localViewStubCompat = (ViewStubCompat)this.mSubDecor.findViewById(R.id.action_mode_bar_stub);
          ...
          break label341;
          label561: break;
          label563: bool1 = false;
          break label384;
          label569: this.mActionModeView.setAlpha(1.0F);
        ...
        label621: continue;
        label623: this.mActionMode = null;
      }
    }
    ...
    implements ActionMode.Callback
  {
    ...
    public ActionModeCallbackWrapperV9(ActionMode.Callback arg2)
    {
      Object localObject;
  ...
  protected static final class PanelFeatureState
  {
      ...
      implements Parcelable
    {
      ...
      {
        public AppCompatDelegateImplV9.PanelFeatureState.SavedState createFromParcel(Parcel paramParcel)
        {
          return AppCompatDelegateImplV9.PanelFeatureState.SavedState.readFromParcel(paramParcel, null);
        }

        public AppCompatDelegateImplV9.PanelFeatureState.SavedState createFromParcel(Parcel paramParcel, ClassLoader paramClassLoader)
        {
          return AppCompatDelegateImplV9.PanelFeatureState.SavedState.readFromParcel(paramParcel, paramClassLoader);
        }

        public AppCompatDelegateImplV9.PanelFeatureState.SavedState[] newArray(int paramInt)
        {
          return new AppCompatDelegateImplV9.PanelFeatureState.SavedState[paramInt];
        }
      };
      int featureId;
      boolean isOpen;
