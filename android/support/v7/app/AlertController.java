...
class AlertController
{
  ...
  private final View.OnClickListener mButtonHandler = new View.OnClickListener()
  {
    public void onClick(View paramView)
    {
      ...
      while (true)
      {
        ...
        return;
        if ((paramView == AlertController.this.mButtonNegative) && (AlertController.this.mButtonNegativeMessage != null))
        {
          localMessage = Message.obtain(AlertController.this.mButtonNegativeMessage);
          continue;
        }
        if ((paramView == AlertController.this.mButtonNeutral) && (AlertController.this.mButtonNeutralMessage != null))
        {
  ...
  private void setScrollIndicators(ViewGroup paramViewGroup, View paramView, int paramInt1, int paramInt2)
  {
    ...
    do
    {
      ...
      {
        this.mScrollView.setOnScrollChangeListener(new NestedScrollView.OnScrollChangeListener(localView3, localView4)
        {
        ...
        this.mScrollView.post(new Runnable(localView3, localView4)
        {
          public void run()
          {
      ...
      {
        this.mListView.setOnScrollListener(new AbsListView.OnScrollListener(localView3, localView4)
        {
        ...
        this.mListView.post(new Runnable(localView3, localView4)
        {
          public void run()
          {
  ...
  private void setupButtons(ViewGroup paramViewGroup)
  {
    ...
    if (TextUtils.isEmpty(this.mButtonPositiveText))
    {
      ...
      label90: this.mButtonNeutral = ((Button)paramViewGroup.findViewById(16908315));
      this.mButtonNeutral.setOnClickListener(this.mButtonHandler);
      if (!TextUtils.isEmpty(this.mButtonNeutralText))
        break label228;
      this.mButtonNeutral.setVisibility(8);
      label134: if (shouldCenterSingleButton(this.mContext))
      {
        if (i != 1)
          break label254;
    ...
    while (true)
    {
      ...
      i = 0x0 | 0x1;
      break;
      label202: this.mButtonNegative.setText(this.mButtonNegativeText);
      this.mButtonNegative.setVisibility(0);
      i |= 2;
      break label90;
      label228: this.mButtonNeutral.setText(this.mButtonNeutralText);
  ...
  private void setupView()
  {
    ...
    label415: label421: label427: label456: label465: label471: for (int m = 2; ; m = 0)
    {
      setScrollIndicators(localViewGroup3, (View)localObject, k | m, 3);
      ListView localListView1 = this.mListView;
      if ((localListView1 != null) && (this.mAdapter != null))
      {
        localListView1.setAdapter(this.mAdapter);
        int j = this.mCheckedItem;
        if (j > -1)
        {
          localListView1.setItemChecked(j, true);
  ...
  public static class AlertParams
  {
    ...
    private void createListView(AlertController paramAlertController)
    {
      ...
      if (this.mIsMultiChoice)
        ...
        {
          localObject = new ArrayAdapter(this.mContext, paramAlertController.mMultiChoiceItemLayout, 16908308, this.mItems, localRecycleListView)
          {
            public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
            {
              View localView = super.getView(paramInt, paramView, paramViewGroup);
              if ((AlertController.AlertParams.this.mCheckedItems != null) && (AlertController.AlertParams.this.mCheckedItems[paramInt] != 0))
          ...
          if (this.mOnClickListener == null)
            break label290;
          localRecycleListView.setOnItemClickListener(new AdapterView.OnItemClickListener(paramAlertController)
          {
            public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
            {
              AlertController.AlertParams.this.mOnClickListener.onClick(this.val$dialog.mDialog, paramInt);
              if (!AlertController.AlertParams.this.mIsSingleChoice)
                this.val$dialog.mDialog.dismiss();
            }
          });
          label106: if (this.mOnItemSelectedListener != null)
      ...
      while (true)
      {
        ...
        localObject = new CursorAdapter(localContext2, localCursor2, false, localRecycleListView, paramAlertController)
        {
          ...
          public void bindView(View paramView, Context paramContext, Cursor paramCursor)
          {
            ...
            AlertController.RecycleListView localRecycleListView = this.val$listView;
            int k = paramCursor.getPosition();
            if (paramCursor.getInt(this.mIsCheckedIndex) == i);
            while (true)
            {
          ...
          {
            return AlertController.AlertParams.this.mInflater.inflate(this.val$dialog.mMultiChoiceItemLayout, paramViewGroup, false);
          }
        };
        break;
        if (this.mIsSingleChoice);
        ...
        label251: if (this.mAdapter != null)
        {
        ...
        break;
        label290: if (this.mOnCheckboxClickListener == null)
          break label106;
        localRecycleListView.setOnItemClickListener(new AdapterView.OnItemClickListener(localRecycleListView, paramAlertController)
        {
          public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
          {
            if (AlertController.AlertParams.this.mCheckedItems != null)
              AlertController.AlertParams.this.mCheckedItems[paramInt] = this.val$listView.isItemChecked(paramInt);
            AlertController.AlertParams.this.mOnCheckboxClickListener.onClick(this.val$dialog.mDialog, paramInt, this.val$listView.isItemChecked(paramInt));
          }
        });
        break label106;
        label314: if (!this.mIsMultiChoice)
          continue;
  ...
  public static class RecycleListView extends ListView
  {
    ...
    public void setHasDecor(boolean paramBoolean1, boolean paramBoolean2)
    {
      ...
      label51: label60: for (int m = getPaddingBottom(); ; m = this.mPaddingBottomNoButtons)
      {
        setPadding(i, j, k, m);
        return;
