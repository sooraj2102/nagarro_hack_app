  ...
  implements MenuHelper
{
  ...
  private MenuPopup createPopup()
  {
    ...
    label166: label171: for (Object localObject = new CascadingMenuPopup(this.mContext, this.mAnchorView, this.mPopupStyleAttr, this.mPopupStyleRes, this.mOverflowOnly); ; localObject = new StandardMenuPopup(this.mContext, this.mMenu, this.mAnchorView, this.mPopupStyleAttr, this.mPopupStyleRes, this.mOverflowOnly))
    {
  ...
  private void showPopup(int paramInt1, int paramInt2, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (paramBoolean1)
    {
      ...
      localMenuPopup.setEpicenterBounds(new Rect(paramInt1 - i, paramInt2 - i, paramInt1 + i, paramInt2 + i));
    }
    localMenuPopup.show();
  }
