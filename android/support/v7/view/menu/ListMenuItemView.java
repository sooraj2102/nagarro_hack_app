  ...
  implements MenuView.ItemView
{
  ...
  public ListMenuItemView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    this.mBackground = localTintTypedArray.getDrawable(R.styleable.MenuView_android_itemBackground);
    this.mTextAppearance = localTintTypedArray.getResourceId(R.styleable.MenuView_android_itemTextAppearance, -1);
    this.mPreserveIconSpacing = localTintTypedArray.getBoolean(R.styleable.MenuView_preserveIconSpacing, false);
    this.mTextAppearanceContext = paramContext;
    this.mSubMenuArrow = localTintTypedArray.getDrawable(R.styleable.MenuView_subMenuArrow);
  ...
  public void setCheckable(boolean paramBoolean)
  {
    ...
    label131: label138: this.mRadioButton.setVisibility(8);
  }
