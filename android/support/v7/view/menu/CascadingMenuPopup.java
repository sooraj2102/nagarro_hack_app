  ...
  private final MenuItemHoverListener mMenuItemHoverListener = new MenuItemHoverListener()
  {
    public void onItemHoverEnter(@NonNull MenuBuilder paramMenuBuilder, @NonNull MenuItem paramMenuItem)
    {
      ...
      while (true)
      {
        if (j < k)
        {
          if (paramMenuBuilder == ((CascadingMenuPopup.CascadingMenuInfo)CascadingMenuPopup.this.mShowingMenus.get(j)).menu)
            i = j;
        }
        else
        {
      ...
      for (CascadingMenuPopup.CascadingMenuInfo localCascadingMenuInfo = (CascadingMenuPopup.CascadingMenuInfo)CascadingMenuPopup.this.mShowingMenus.get(m); ; localCascadingMenuInfo = null)
      {
        1 local1 = new Runnable(localCascadingMenuInfo, paramMenuItem, paramMenuBuilder)
        {
          public void run()
          {
        ...
        CascadingMenuPopup.this.mSubMenuHoverHandler.postAtTime(local1, paramMenuBuilder, l);
        return;
      }
    }
  ...
  private void showMenu(@NonNull MenuBuilder paramMenuBuilder)
  {
    ...
    if ((!isShowing()) && (this.mForceShowIcon))
    {
      ...
      if (k == 0)
        break label440;
      i1 = m + i;
      label213: localMenuPopupWindow.setHorizontalOffset(i1);
    ...
    while (true)
    {
      ...
      break;
      label374: localCascadingMenuInfo1 = null;
      localView = null;
      break label130;
      label383: k = 0;
      break label164;
      label389: int[] arrayOfInt1 = new int[2];
      ...
      break label191;
      label440: i1 = m - localView.getWidth();
      break label213;
      label453: if (k != 0)
      {
 ...
 * Qualified Name:     android.support.v7.view.menu.CascadingMenuPopup
