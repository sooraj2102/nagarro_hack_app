  ...
  implements PopupWindow.OnDismissListener, AdapterView.OnItemClickListener, MenuPresenter, View.OnKeyListener
{
  ...
  private boolean tryShow()
  {
    ...
    for (int i = 1; ; i = 0)
    {
      ...
      localView.addOnAttachStateChangeListener(this.mAttachStateChangeListener);
      ...
      this.mPopup.show();
      ListView localListView = this.mPopup.getListView();
      localListView.setOnKeyListener(this);
      if ((this.mShowTitle) && (this.mMenu.getHeaderTitle() != null))
      {
        FrameLayout localFrameLayout = (FrameLayout)LayoutInflater.from(this.mContext).inflate(R.layout.abc_popup_menu_header_item_layout, localListView, false);
