...
public class SortedList<T>
{
  ...
  public SortedList(Class<T> paramClass, Callback<T> paramCallback, int paramInt)
  {
    ...
    this.mData = ((Object[])(Object[])Array.newInstance(paramClass, paramInt));
  ...
  private void addAllInternal(T[] paramArrayOfT)
  {
    ...
    while (true)
    {
      ...
      i = 0;
      break;
      label105: merge(paramArrayOfT, j);
    }
  }
  ...
  private void addToData(int paramInt, T paramT)
  {
    ...
    {
      Object[] arrayOfObject = (Object[])(Object[])Array.newInstance(this.mTClass, 10 + this.mData.length);
  ...
  private void merge(T[] paramArrayOfT, int paramInt)
  {
    ...
    this.mData = ((Object[])(Object[])Array.newInstance(this.mTClass, i));
    this.mMergedSize = 0;
    int j = 0;
    while (true)
    {
      ...
      if ((k == 0) && (this.mCallback.areItemsTheSame(localObject, ?)))
      {
  ...
  {
    addAll(paramCollection.toArray((Object[])(Object[])Array.newInstance(this.mTClass, paramCollection.size())), true);
  }

  public void addAll(T[] paramArrayOfT)
  {
    addAll(paramArrayOfT, false);
  }
  ...
  public void addAll(T[] paramArrayOfT, boolean paramBoolean)
  {
    ...
    Object[] arrayOfObject = (Object[])(Object[])Array.newInstance(this.mTClass, paramArrayOfT.length);
