  ...
  implements RecyclerView.SmoothScroller.ScrollVectorProvider
{
  ...
  private int fill(RecyclerView.Recycler paramRecycler, LayoutState paramLayoutState, RecyclerView.State paramState)
  {
    ...
    label158: label169: label190: int i5;
    label223: int i4;
    int i7;
    label347: int i6;
    if (this.mLayoutState.mInfinite)
      if (paramLayoutState.mLayoutDirection == 1)
      {
        ...
        label383: if (!localLayoutParams.mFullSpan)
          break label827;
        updateAllRemainingSpans(this.mLayoutState.mLayoutDirection, i);
        label404: recycle(paramRecycler, this.mLayoutState);
    ...
    while (true)
    {
      ...
      break;
      label495: j = this.mPrimaryOrientation.getStartAfterPadding();
      break label62;
      label507: i3 = 0;
      break label137;
      label513: localSpan = getNextSpan(paramLayoutState);
      break label158;
      label523: localSpan = this.mSpans[i2];
      break label169;
      label535: addView(localView, 0);
      break label190;
      label545: i5 = localSpan.getEndLine(j);
      break label223;
      label557: if (localLayoutParams.mFullSpan);
      ...
      label645: if (paramLayoutState.mLayoutDirection == 1)
      {
        if (!areAllEndsEqual());
        for (i9 = 1; ; i9 = 0)
        {
      ...
      label723: i7 = this.mSecondaryOrientation.getEndAfterPadding() - (-1 + this.mSpanCount - localSpan.mIndex) * this.mSizePerSpan;
      break label347;
      label753: if (localLayoutParams.mFullSpan);
      ...
      label810: layoutDecoratedWithMargins(localView, i5, i6, i4, i7);
      break label383;
      label827: int i8 = this.mLayoutState.mLayoutDirection;
      updateRemainingSpans(localSpan, i8, i);
      break label404;
      label849: this.mRemainingSpans.set(localSpan.mIndex, false);
    }
    label865: if (k == 0)
  ...
  private void handleUpdate(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if (this.mShouldReverseLayout)
    {
      ...
      k = paramInt2 + 1;
      j = paramInt1;
      label32: this.mLazySpanLookup.invalidateAfter(j);
      switch (paramInt3)
      {
      default:
        label76: if (k > i)
    ...
    while (true)
    {
      ...
      break;
      label93: k = paramInt1 + 1;
      j = paramInt2;
      break label32;
      label104: j = paramInt1;
  ...
  private void onLayoutChildren(RecyclerView.Recycler paramRecycler, RecyclerView.State paramState, boolean paramBoolean)
  {
    ...
    while (true)
    {
      ...
      m = 0;
      break;
      label251: resolveShouldLayoutReverse();
      localAnchorInfo.mLayoutFromEnd = this.mShouldReverseLayout;
    }
    label267: label330: label463: int n;
    if ((m != 0) || (this.mAnchorInfo.mSpanReferenceLines == null))
    {
      ...
      fill(paramRecycler, this.mLayoutState, paramState);
      label430: repositionToWrapContentIfNecessary();
      if (getChildCount() > 0)
      {
        if (!this.mShouldReverseLayout)
          break label700;
    ...
    while (true)
    {
      ...
      break label330;
      label644: setLayoutStateDirection(i);
      fill(paramRecycler, this.mLayoutState, paramState);
      setLayoutStateDirection(-1);
      this.mLayoutState.mCurrentPosition = (localAnchorInfo.mPosition + this.mLayoutState.mItemDirection);
      fill(paramRecycler, this.mLayoutState, paramState);
      break label430;
      label700: fixStartGap(paramRecycler, paramState, i);
  ...
  private void repositionToWrapContentIfNecessary()
  {
    ...
    while (true)
    {
      ...
      break label158;
      break;
      label196: if ((isLayoutRTL()) && (this.mOrientation == 1))
      {
  ...
  private void updateLayoutState(int paramInt, RecyclerView.State paramState)
  {
    ...
    label84: label125: LayoutState localLayoutState;
    if (getClipToPadding())
    {
    ...
    while (true)
    {
      ...
      break;
      label180: j = this.mPrimaryOrientation.getTotalSpace();
      i = 0;
      break label84;
  ...
  public void collectAdjacentPrefetchPositions(int paramInt1, int paramInt2, RecyclerView.State paramState, RecyclerView.LayoutManager.LayoutPrefetchRegistry paramLayoutPrefetchRegistry)
  {
    ...
    while (true)
    {
      ...
      i = paramInt2;
      break;
      label29: prepareLayoutStateForDelta(i, paramState);
  ...
  public View onFocusSearchFailed(View paramView, int paramInt, RecyclerView.Recycler paramRecycler, RecyclerView.State paramState)
  {
    ...
    label389: label395: for (int i6 = localSpan.findFirstPartiallyVisibleItemPosition(); ; i6 = localSpan.findLastPartiallyVisibleItemPosition())
    {
  ...
  public Parcelable onSaveInstanceState()
  {
    ...
    while (true)
    {
      ...
      break label101;
      label222: i = getFirstChildPosition();
      break label120;
      label230: k = this.mSpans[j].getStartLine(-2147483648);
      if (k == -2147483648)
        continue;
      k -= this.mPrimaryOrientation.getStartAfterPadding();
    }
    label265: localSavedState.mAnchorPosition = -1;
  ...
  class AnchorInfo
  {
    ...
    void saveSpanReferenceLines(StaggeredGridLayoutManager.Span[] paramArrayOfSpan)
    {
      ...
      for (int j = 0; j < i; j++)
        this.mSpanReferenceLines[j] = paramArrayOfSpan[j].getStartLine(-2147483648);
    }
  }
  ...
  class Span
  {
    ...
    public View getFocusableViewAfter(int paramInt1, int paramInt2)
    {
      ...
      {
        return localObject;
        label88: if (!localView2.hasFocusable())
          continue;
