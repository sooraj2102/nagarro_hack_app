...
public class Toolbar extends ViewGroup
{
  ...
  public Toolbar(Context paramContext, @Nullable AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    1 local1 = new ActionMenuView.OnMenuItemClickListener()
    {
      public boolean onMenuItemClick(MenuItem paramMenuItem)
      {
        if (Toolbar.this.mOnMenuItemClickListener != null)
          return Toolbar.this.mOnMenuItemClickListener.onMenuItemClick(paramMenuItem);
        return false;
      }
    };
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    int i6;
    label96: int i9;
    label128: label160: label192: int i11;
    label296: label328: boolean bool1;
    boolean bool2;
    int i12;
    ...
    for (int i33 = this.mTitleMarginStart; ; i33 = 0)
    {
      ...
      label897: i6 = 0;
      break label96;
      label903: i3 = layoutChildLeft(this.mNavButtonView, i3, arrayOfInt, i6);
      break label128;
      label922: i3 = layoutChildLeft(this.mCollapseButtonView, i3, arrayOfInt, i6);
      break label160;
      label941: i4 = layoutChildRight(this.mMenuView, i4, arrayOfInt, i6);
      break label192;
      label960: i9 = layoutChildLeft(this.mExpandedActionView, i9, arrayOfInt, i6);
      break label296;
      label979: i9 = layoutChildLeft(this.mLogoView, i9, arrayOfInt, i6);
      break label328;
      label998: localTextView1 = this.mSubtitleTextView;
      break label453;
      label1007: localTextView2 = this.mTitleTextView;
      break label464;
      label1016: i13 = 0;
      break label517;
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    if (ViewUtils.isLayoutRtl(this))
    {
      ...
      if (shouldLayout(this.mCollapseButtonView))
      {
        ...
        m = Math.max(m, i29);
        int i30 = this.mCollapseButtonView.getMeasuredState();
        k = View.combineMeasuredStates(k, i30);
      }
      ...
      if (bool2)
      {
        ...
        m = Math.max(m, i27);
        int i28 = this.mMenuView.getMeasuredState();
        k = View.combineMeasuredStates(k, i28);
      }
      ...
      if (shouldLayout(this.mExpandedActionView))
      {
        ...
        m = Math.max(m, i25);
        int i26 = this.mExpandedActionView.getMeasuredState();
        k = View.combineMeasuredStates(k, i26);
      }
      if (shouldLayout(this.mLogoView))
      {
        ...
        m = Math.max(m, i23);
        int i24 = this.mLogoView.getMeasuredState();
        k = View.combineMeasuredStates(k, i24);
      }
    ...
    while (true)
    {
      ...
      m = Math.max(m, i21);
      int i22 = localView.getMeasuredState();
      k = View.combineMeasuredStates(k, i22);
    }
    ...
    if (bool3)
    {
      ...
      int i20 = this.mTitleTextView.getMeasuredState();
      k = View.combineMeasuredStates(k, i20);
    }
    if (shouldLayout(this.mSubtitleTextView))
    {
      ...
      int i19 = this.mSubtitleTextView.getMeasuredState();
      k = View.combineMeasuredStates(k, i19);
    }
    int i12 = i5 + i11;
    int i13 = Math.max(m, i10);
    int i14 = i12 + (getPaddingLeft() + getPaddingRight());
    int i15 = i13 + (getPaddingTop() + getPaddingBottom());
    int i16 = View.resolveSizeAndState(Math.max(i14, getSuggestedMinimumWidth()), paramInt1, 0xFF000000 & k);
    int i17 = View.resolveSizeAndState(Math.max(i15, getSuggestedMinimumHeight()), paramInt2, k << 16);
    if (shouldCollapse())
      i17 = 0;
