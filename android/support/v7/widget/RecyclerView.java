  ...
  implements ScrollingView, NestedScrollingChild2
{
  ...
  public RecyclerView(Context paramContext, @Nullable AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    label335: boolean bool1;
    label409: boolean bool2;
    ...
    while (true)
    {
      ...
      break;
      label648: this.mClipToPadding = true;
      break label335;
      label656: bool1 = false;
      break label409;
      label662: setDescendantFocusability(262144);
    }
  }
  ...
  private boolean didChildRangeChange(int paramInt1, int paramInt2)
  {
    ...
    {
      int j = this.mMinMaxLayoutPositions[1];
      i = 0;
      if (j == paramInt2);
    }
    else
  ...
  private boolean isPreferredNextFocus(View paramView1, View paramView2, int paramInt)
  {
    ...
    while (true)
    {
      ...
      label110: continue;
      label112: return isPreferredNextFocusAbsolute(paramView1, paramView2, 33);
    }
  ...
  private void processAdapterUpdatesAndSetAnimationFlags()
  {
    ...
    int i;
    label54: boolean bool2;
    label114: State localState2;
  ...
  private void saveFocusInfo()
  {
    ...
    while (true)
    {
      ...
      l = -1L;
      break;
      label142: if (localViewHolder.isRemoved())
      {
  ...
  public ViewHolder findViewHolderForAdapterPosition(int paramInt)
  {
    ...
    label93: return localViewHolder1;
  }
  ...
  public ViewHolder findViewHolderForItemId(long paramLong)
  {
    ...
    label99: return localViewHolder2;
  }
  ...
  ViewHolder findViewHolderForPosition(int paramInt, boolean paramBoolean)
  {
    ...
    label101: return (ViewHolder)localObject2;
  }
  ...
  public View focusSearch(View paramView, int paramInt)
  {
    ...
    if ((this.mAdapter != null) && (this.mLayout != null) && (!isComputingLayout()) && (!this.mLayoutFrozen))
    {
      ...
      if ((j == 0) && (this.mLayout.canScrollHorizontally()))
      {
        ...
        if ((m ^ k) == 0)
          break label241;
        n = 66;
        label167: if (localFocusFinder.findNextFocus(this, paramView, n) != null)
          break label248;
      }
    }
    label216: label223: label229: label235: label241: label248: for (int j = 1; ; j = 0)
    {
      if (FORCE_ABS_FOCUS_SEARCH_DIRECTION)
        paramInt = n;
      if (j == 0)
    ...
    label254: eatRequestLayout();
    this.mLayout.onFocusSearchFailed(paramView, paramInt, this.mRecycler, this.mState);
    resumeRequestLayout(false);
    label281: View localView2 = localFocusFinder.findNextFocus(this, paramView, paramInt);
    while ((localView2 != null) && (!localView2.hasFocusable()))
    {
      if (getFocusedChild() == null)
      {
        return super.focusSearch(paramView, paramInt);
        label318: localView2 = localFocusFinder.findNextFocus(this, paramView, paramInt);
  ...
  void initAdapterManager()
  {
    this.mAdapterHelper = new AdapterHelper(new AdapterHelper.Callback()
    {
      ...
      public void offsetPositionsForRemovingInvisible(int paramInt1, int paramInt2)
      {
        ...
        localState.mDeletedInvisibleItemCountSincePreviousLayout = (paramInt2 + localState.mDeletedInvisibleItemCountSincePreviousLayout);
      }
    ...
    while (true)
    {
      ...
      if (ALLOW_THREAD_GAP_WORK)
      {
        ...
        if (this.mGapWorker == null)
        {
          ...
          this.mGapWorker.mFrameIntervalNs = ()(1.0E+09F / f1);
  ...
  public boolean onInterceptTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    while (this.mScrollState == 1)
    {
      ...
      continue;
      this.mScrollPointerId = paramMotionEvent.getPointerId(j);
      int i6 = (int)(0.5F + paramMotionEvent.getX(j));
      this.mLastTouchX = i6;
      this.mInitialTouchX = i6;
      int i7 = (int)(0.5F + paramMotionEvent.getY(j));
      this.mLastTouchY = i7;
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    while (true)
    {
      ...
      label776: label788: label806: for (int i7 = i3; ; i7 = 0)
      {
  ...
  public static abstract class LayoutManager
  {
    ...
    private final ViewBoundsCheck.Callback mHorizontalBoundCheckCallback = new ViewBoundsCheck.Callback()
    {
      ...
      public int getChildEnd(View paramView)
      {
        ...
        return RecyclerView.LayoutManager.this.getDecoratedRight(paramView) + localLayoutParams.rightMargin;
      }

      public int getChildStart(View paramView)
      {
        RecyclerView.LayoutParams localLayoutParams = (RecyclerView.LayoutParams)paramView.getLayoutParams();
        return RecyclerView.LayoutManager.this.getDecoratedLeft(paramView) - localLayoutParams.leftMargin;
      }
    ...
    private final ViewBoundsCheck.Callback mVerticalBoundCheckCallback = new ViewBoundsCheck.Callback()
    {
      ...
      {
        RecyclerView.LayoutParams localLayoutParams = (RecyclerView.LayoutParams)paramView.getLayoutParams();
        return RecyclerView.LayoutManager.this.getDecoratedBottom(paramView) + localLayoutParams.bottomMargin;
      }

      public int getChildStart(View paramView)
      {
        RecyclerView.LayoutParams localLayoutParams = (RecyclerView.LayoutParams)paramView.getLayoutParams();
        return RecyclerView.LayoutManager.this.getDecoratedTop(paramView) - localLayoutParams.topMargin;
      }
    ...
    private int[] getChildRectangleOnScreenScrollAmount(RecyclerView paramRecyclerView, View paramView, Rect paramRect, boolean paramBoolean)
    {
      ...
      label216: for (int i9 = i5; ; i9 = Math.min(i1 - j, i7))
      {
        arrayOfInt[0] = i8;
        arrayOfInt[1] = i9;
        return arrayOfInt;
    ...
    public boolean performAccessibilityAction(RecyclerView.Recycler paramRecycler, RecyclerView.State paramState, int paramInt, Bundle paramBundle)
    {
      ...
      while (true)
      {
        ...
        while ((j != 0) || (i != 0))
        {
          ...
          return true;
          boolean bool3 = this.mRecyclerView.canScrollVertically(-1);
          j = 0;
          if (bool3)
            j = -(getHeight() - getPaddingTop() - getPaddingBottom());
          boolean bool4 = this.mRecyclerView.canScrollHorizontally(-1);
          i = 0;
          if (!bool4)
            continue;
          i = -(getWidth() - getPaddingLeft() - getPaddingRight());
          continue;
          boolean bool1 = this.mRecyclerView.canScrollVertically(1);
          j = 0;
          if (bool1)
            j = getHeight() - getPaddingTop() - getPaddingBottom();
          boolean bool2 = this.mRecyclerView.canScrollHorizontally(1);
          i = 0;
          if (!bool2)
            continue;
          i = getWidth() - getPaddingLeft() - getPaddingRight();
    ...
    public boolean requestChildRectangleOnScreen(RecyclerView paramRecyclerView, View paramView, Rect paramRect, boolean paramBoolean1, boolean paramBoolean2)
    {
      ...
      if (paramBoolean2)
      {
        boolean bool = isFocusedChildVisibleAfterScrolling(paramRecyclerView, i, j);
        k = 0;
        if (!bool);
      }
      else if (i == 0)
  ...
  public final class Recycler
  {
    ...
    void recycleViewHolderInternal(RecyclerView.ViewHolder paramViewHolder)
    {
      ...
      boolean bool2 = RecyclerView.ViewHolder.access$900(paramViewHolder);
      int i;
      int k;
      int m;
      int n;
    ...
    RecyclerView.ViewHolder tryGetViewHolderForPositionByDeadline(int paramInt, boolean paramBoolean, long paramLong)
    {
      ...
      else if (localObject1 == null)
      {
        ...
        if (localObject1 != null)
        {
          ...
          if (!paramBoolean)
          {
            ...
            label186: recycleViewHolderInternal((RecyclerView.ViewHolder)localObject1);
          }
          localObject1 = null;
        }
      }
      ...
      while (true)
      {
        ...
        i = 0;
        break;
        label309: if (!((RecyclerView.ViewHolder)localObject1).wasReturnedFromScrap())
          break label186;
        ((RecyclerView.ViewHolder)localObject1).clearReturnedFromScrapFlag();
        break label186;
        label325: i = 1;
      }
      label331: int m = RecyclerView.this.mAdapter.getItemViewType(k);
      if (RecyclerView.this.mAdapter.hasStableIds())
      {
      ...
      while (true)
      {
        label673: if ((i != 0) && (!RecyclerView.this.mState.isPreLayout()) && (((RecyclerView.ViewHolder)localObject1).hasAnyOfTheFlags(8192)))
        {
        ...
        if ((RecyclerView.this.mState.isPreLayout()) && (((RecyclerView.ViewHolder)localObject1).isBound()))
        {
          ...
          label841: localLayoutParams1.mViewHolder = ((RecyclerView.ViewHolder)localObject1);
          if ((i == 0) || (!bool2))
            break label975;
        }
        label926: label975: for (boolean bool3 = true; ; bool3 = false)
        {
    ...
    implements Runnable
  {
    ...
    public void run()
    {
      ...
      if (localOverScroller.computeScrollOffset())
      {
        ...
        if (m != 0)
        {
          i1 = RecyclerView.this.mLayout.scrollVerticallyBy(m, RecyclerView.this.mRecycler, RecyclerView.this.mState);
          i3 = m - i1;
        }
        TraceCompat.endSection();
      ...
      while (true)
      {
        ...
        int i8;
        label424: int i9;
        if ((!RecyclerView.this.dispatchNestedScroll(n, i1, i2, i3, null, 1)) && ((i2 != 0) || (i3 != 0)))
        {
          i7 = (int)localOverScroller.getCurrVelocity();
          i8 = 0;
          if (i2 != i)
          {
            if (i2 >= 0)
          ...
          label444: if (RecyclerView.this.getOverScrollMode() != 2)
            RecyclerView.this.absorbGlows(i8, i9);
          if (((i8 != 0) || (i2 == i) || (localOverScroller.getFinalX() == 0)) && ((i9 != 0) || (i3 == j) || (localOverScroller.getFinalY() == 0)))
            localOverScroller.abortAnimation();
        }
        if ((n != 0) || (i1 != 0))
          RecyclerView.this.dispatchOnScrolled(n, i1);
        if (!RecyclerView.this.awakenScrollBars())
          RecyclerView.this.invalidate();
        int i4;
        label574: int i5;
        label602: int i6;
        if ((m != 0) && (RecyclerView.this.mLayout.canScrollVertically()) && (i1 == m))
        {
          i4 = 1;
          if ((k == 0) || (!RecyclerView.this.mLayout.canScrollHorizontally()) || (n != k))
            break label806;
          i5 = 1;
          if (((k != 0) || (m != 0)) && (i5 == 0) && (i4 == 0))
            break label812;
          i6 = 1;
          label625: if ((!localOverScroller.isFinished()) && ((i6 != 0) || (RecyclerView.this.hasNestedScrollingParent(1))))
            break label818;
        ...
        while (true)
        {
          ...
          return;
          label713: if (localSmoothScroller.getTargetPosition() >= i10)
          {
            localSmoothScroller.setTargetPosition(i10 - 1);
            localSmoothScroller.onAnimation(k - i2, m - i3);
            break;
          }
          localSmoothScroller.onAnimation(k - i2, m - i3);
          break;
