  ...
  implements ActionProvider.SubUiVisibilityListener
{
  ...
  public boolean flagActionItems()
  {
    ...
    int i3;
    int i4;
    label62: MenuItemImpl localMenuItemImpl3;
    if (this.mMenu != null)
    {
    ...
    while (true)
    {
      ...
      localArrayList = null;
      break;
      label120: if (localMenuItemImpl3.requestsActionButton())
      {
        i1++;
        continue;
      }
    ...
    label140: if ((this.mReserveOverflow) && ((i3 != 0) || (n + i1 > j)))
      j--;
    int i5 = j - n;
    ...
    if (i8 < i)
    {
      ...
      if (localMenuItemImpl1.requiresActionButton())
      {
        ...
        if (this.mStrictWidthLimit)
        {
          ...
          label307: int i13 = localView2.getMeasuredWidth();
          k -= i13;
          if (i2 == 0)
            i2 = i13;
      ...
      while (true)
      {
        ...
        if (localMenuItemImpl1.requestsActionButton())
        {
          ...
          boolean bool3;
          label428: View localView1;
          label496: boolean bool5;
          ...
          while (true)
          {
            ...
            bool3 = false;
            break label428;
            label583: localView1.measure(m, m);
            break label496;
            label595: bool5 = false;
            break label534;
            label601: if (k + i2 > 0);
  ...
  public void updateMenuView(boolean paramBoolean)
  {
    ...
    while (true)
    {
      ...
      for (i = 1; ; i = 0)
        break;
      label272: if ((this.mOverflowButton == null) || (this.mOverflowButton.getParent() != this.mMenuView))
        continue;
  ...
  {
    public ActionButtonSubmenu(Context paramSubMenuBuilder, SubMenuBuilder paramView, View arg4)
    {
      super(paramView, localView, false, R.attr.actionOverflowMenuStyle);
      if (!((MenuItemImpl)paramView.getItem()).isActionButton())
    ...
    implements Parcelable
  {
    public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.Creator()
    {
      ...
      public ActionMenuPresenter.SavedState[] newArray(int paramInt)
      {
