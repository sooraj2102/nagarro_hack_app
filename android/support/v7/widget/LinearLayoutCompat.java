...
public class LinearLayoutCompat extends ViewGroup
{
  ...
  void measureHorizontal(int paramInt1, int paramInt2)
  {
    ...
    if ((i2 == 1073741824) && (localLayoutParams3.width == 0) && (localLayoutParams3.weight > 0.0F))
      if (i6 != 0)
      {
        ...
        int i36 = localView4.getMeasuredState();
        j = View.combineMeasuredStates(j, i36);
        if (bool1)
        {
    ...
    while (true)
    {
      ...
      if (f1 == 0.0F)
      {
        ...
        if (i6 == 0)
          break label733;
        this.mTotalLength += i31 + localLayoutParams3.leftMargin + localLayoutParams3.rightMargin + getNextLocationOffset(localView4);
      }
      while (true)
      {
        if (!bool2)
        ...
        i30 = 0;
        break label640;
        label733: int i32 = this.mTotalLength;
        this.mTotalLength = Math.max(i32, i32 + i31 + localLayoutParams3.leftMargin + localLayoutParams3.rightMargin + getNextLocationOffset(localView4));
      }
    ...
    if ((i5 != 0) || ((i11 != 0) && (f1 > 0.0F)))
    {
      ...
      do
      {
        ...
        if (f3 > 0.0F)
        {
          ...
          int i25 = 0xFF000000 & localView1.getMeasuredState();
          j = View.combineMeasuredStates(j, i25);
        }
        if (i6 == 0)
          break label1677;
    ...
    do
    {
      ...
      setMeasuredDimension(i10 | 0xFF000000 & j, View.resolveSizeAndState(i14, paramInt2, j << 16));
      if (i4 != 0)
  ...
  void measureVertical(int paramInt1, int paramInt2)
  {
    ...
    if (i8 < i1)
    {
      ...
      i = Math.max(i, i28);
      j = View.combineMeasuredStates(j, localView4.getMeasuredState());
      ...
      while (true)
      {
        ...
        if (f3 > 0.0F)
        {
          ...
          if ((localLayoutParams1.height != 0) || (i3 != 1073741824))
          {
            ...
            j = View.combineMeasuredStates(j, 0xFFFFFF00 & localView1.getMeasuredState());
          }
        }
        else
        {
    ...
    do
    {
      if ((n == 0) && (i2 != 1073741824))
        i = k;
      setMeasuredDimension(View.resolveSizeAndState(Math.max(i + (getPaddingLeft() + getPaddingRight()), getSuggestedMinimumWidth()), paramInt1, j), i9);
      if (i4 != 0)
