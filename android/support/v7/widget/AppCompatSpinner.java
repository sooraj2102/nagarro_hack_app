  ...
  implements TintableBackgroundView
{
  ...
  public AppCompatSpinner(Context paramContext, AttributeSet paramAttributeSet, int paramInt1, int paramInt2, Resources.Theme paramTheme)
  {
    ...
    while (true)
    {
      try
      {
        ...
        if (paramInt2 != 1)
          continue;
        DropdownPopup localDropdownPopup = new DropdownPopup(this.mPopupContext, paramAttributeSet, paramInt1);
        ...
        this.mForwardingListener = new ForwardingListener(this, localDropdownPopup)
        {
  ...
  private class DropdownPopup extends ListPopupWindow
  {
      ...
      setOnItemClickListener(new AdapterView.OnItemClickListener(AppCompatSpinner.this)
      {
        public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
        {
          ...
          if (AppCompatSpinner.this.getOnItemClickListener() != null)
            AppCompatSpinner.this.performItemClick(paramView, paramInt, AppCompatSpinner.DropdownPopup.this.mAdapter.getItemId(paramInt));
    ...
    public void show()
    {
      ...
      setOnDismissListener(new PopupWindow.OnDismissListener(local2)
      {
