...
public class GridLayoutManager extends LinearLayoutManager
{
  ...
  private void ensureAnchorIsInCorrectSpan(RecyclerView.Recycler paramRecycler, RecyclerView.State paramState, LinearLayoutManager.AnchorInfo paramAnchorInfo, int paramInt)
  {
    ...
    while (true)
    {
      int j = getSpanIndex(paramRecycler, paramState, paramAnchorInfo.mPosition);
      if (i != 0)
      {
  ...
  View findReferenceChild(RecyclerView.Recycler paramRecycler, RecyclerView.State paramState, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    while (true)
    {
      ...
      k = -1;
      break;
      label102: if (((RecyclerView.LayoutParams)((View)localObject3).getLayoutParams()).isItemRemoved())
      {
    ...
    label168: if (localObject2 != null);
    while (true)
    {
      localObject3 = localObject2;
      label177: return localObject3;
  ...
  void layoutChunk(RecyclerView.Recycler paramRecycler, RecyclerView.State paramState, LinearLayoutManager.LayoutState paramLayoutState, LinearLayoutManager.LayoutChunkResult paramLayoutChunkResult)
  {
    ...
    if (i4 < n)
    {
      ...
      for (int i14 = View.MeasureSpec.makeMeasureSpec(i2 - i10, 1073741824); ; i14 = getChildMeasureSpec(i12, 1073741824, i10, localLayoutParams2.height, false))
      {
        ...
        i4++;
        break;
        label704: i13 = View.MeasureSpec.makeMeasureSpec(i2 - i11, 1073741824);
      }
    }
    ...
    while (true)
    {
      ...
      i8 = 0;
      break;
      label992: i5 = getPaddingLeft() + this.mCachedBorders[localLayoutParams1.mSpanIndex];
      i6 = i5 + this.mOrientationHelper.getDecoratedMeasurementInOther(localView1);
      continue;
      label1026: i7 = getPaddingTop() + this.mCachedBorders[localLayoutParams1.mSpanIndex];
      i8 = i7 + this.mOrientationHelper.getDecoratedMeasurementInOther(localView1);
    }
    label1060: Arrays.fill(this.mSet, null);
  }
  ...
  public View onFocusSearchFailed(View paramView, int paramInt, RecyclerView.Recycler paramRecycler, RecyclerView.State paramState)
  {
    ...
    while (true)
    {
      ...
      label228: i2 = 0;
      break label127;
      label234: if ((localView3.hasFocusable()) && (i9 != i7))
        if (localObject != null)
          break label193;
      while (true)
      {
