  ...
  implements ItemTouchHelper.ViewDropHandler, RecyclerView.SmoothScroller.ScrollVectorProvider
{
  ...
  private boolean updateAnchorFromChildren(RecyclerView.Recycler paramRecycler, RecyclerView.State paramState, AnchorInfo paramAnchorInfo)
  {
    ...
    label168: label170: label176: for (int j = this.mOrientationHelper.getEndAfterPadding(); ; j = this.mOrientationHelper.getStartAfterPadding())
    {
  ...
  public PointF computeScrollVectorForPosition(int paramInt)
  {
    ...
    int m;
    for (int k = -1; this.mOrientation == 0; m = 1)
  ...
  View findReferenceChild(RecyclerView.Recycler paramRecycler, RecyclerView.State paramState, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    while (true)
    {
      ...
      k = -1;
      break;
      label114: if ((this.mOrientationHelper.getDecoratedStart((View)localObject3) < j) && (this.mOrientationHelper.getDecoratedEnd((View)localObject3) >= i))
        break label163;
      if (localObject2 != null)
        continue;
      localObject2 = localObject3;
    }
    label154: if (localObject2 != null);
    while (true)
    {
      localObject3 = localObject2;
      label163: return localObject3;
  ...
  public void onLayoutChildren(RecyclerView.Recycler paramRecycler, RecyclerView.State paramState)
  {
    ...
    if ((!this.mAnchorInfo.mValid) || (this.mPendingScrollPosition != -1) || (this.mPendingSavedState != null))
    {
      ...
      if ((paramState.isPreLayout()) && (this.mPendingScrollPosition != -1) && (this.mPendingScrollPositionOffset != -2147483648))
      {
        ...
        if (localView2 != null)
        {
          if (!this.mShouldReverseLayout)
            break label693;
          i17 = this.mOrientationHelper.getEndAfterPadding() - this.mOrientationHelper.getDecoratedEnd(localView2) - this.mPendingScrollPositionOffset;
          if (i17 <= 0)
            break label724;
          m += i17;
        }
      ...
      label599: layoutForPredictiveAnimations(paramRecycler, paramState, i4, i2);
    ...
    while (true)
    {
      ...
      k = 0;
      break label167;
      label693: int i16 = this.mOrientationHelper.getDecoratedStart(localView2) - this.mOrientationHelper.getStartAfterPadding();
      ...
      label734: i1 = -1;
      break label293;
      label740: if (this.mShouldReverseLayout);
      for (i1 = -1; ; i1 = 1)
        break;
      label759: updateLayoutStateToFillEnd(this.mAnchorInfo);
      this.mLayoutState.mExtra = n;
      fill(paramRecycler, this.mLayoutState, paramState, false);
      i2 = this.mLayoutState.mOffset;
      ...
      i2 = this.mLayoutState.mOffset;
      break label530;
      label950: int i6 = fixLayoutStartGap(i4, paramRecycler, paramState, true);
      int i7 = i4 + i6;
      int i8 = i2 + i6;
      ...
      i2 = i8 + i9;
      break label599;
      label1003: this.mAnchorInfo.reset();
    }
  }
  ...
  int scrollBy(int paramInt, RecyclerView.Recycler paramRecycler, RecyclerView.State paramState)
  {
    ...
    label116: for (int m = i * k; ; m = paramInt)
    {
      this.mOrientationHelper.offsetChildren(-m);
      ...
      do
      {
        ...
        do
        {
          while (true)
          {
            ...
            if (!this.mLayoutFromEnd)
              break;
            int i2 = LinearLayoutManager.this.mOrientationHelper.getEndAfterPadding() - i - LinearLayoutManager.this.mOrientationHelper.getDecoratedEnd(paramView);
            ...
            int i6 = i4 - (i5 + Math.min(LinearLayoutManager.this.mOrientationHelper.getDecoratedStart(paramView) - i5, 0));
            if (i6 >= 0)
              continue;
