...
public class ActionBarContextView extends AbsActionBarView
{
  ...
  public void initForMode(ActionMode paramActionMode)
  {
    ...
    while (true)
    {
      this.mClose.findViewById(R.id.action_mode_close_button).setOnClickListener(new View.OnClickListener(paramActionMode)
      {
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    label87: int i1;
    label99: int m;
    label223: ActionMenuView localActionMenuView;
    if (bool1)
    {
    ...
    label272: label282: label292: label306: for (boolean bool2 = true; ; bool2 = false)
    {
