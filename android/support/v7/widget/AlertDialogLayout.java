  ...
  private boolean tryOnMeasure(int paramInt1, int paramInt2)
  {
    ...
    if (localObject3 != null)
      if (k != 0)
        break label485;
    int i7;
    label485: for (int i15 = 0; ; i15 = View.MeasureSpec.makeMeasureSpec(Math.max(0, m - i1), k))
    {
    ...
    setMeasuredDimension(View.resolveSizeAndState(i7 + (getPaddingLeft() + getPaddingRight()), paramInt1, i2), View.resolveSizeAndState(i1, paramInt2, 0));
    if (n != 1073741824)
