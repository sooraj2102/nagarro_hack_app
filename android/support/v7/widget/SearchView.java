  ...
  implements CollapsibleActionView
{
  ...
  private final View.OnClickListener mOnClickListener = new View.OnClickListener()
  {
    public void onClick(View paramView)
    {
      ...
      while (paramView != SearchView.this.mSearchSrcTextView);
  ...
  private final AdapterView.OnItemClickListener mOnItemClickListener = new AdapterView.OnItemClickListener()
  {
    ...
    {
      SearchView.this.onItemClicked(paramInt, 0, null);
    }
  };
  private final AdapterView.OnItemSelectedListener mOnItemSelectedListener = new AdapterView.OnItemSelectedListener()
  {
    ...
    {
      SearchView.this.onItemSelected(paramInt);
    }
  ...
  View.OnKeyListener mTextKeyListener = new View.OnKeyListener()
  {
    public boolean onKey(View paramView, int paramInt, KeyEvent paramKeyEvent)
    {
      ...
      while ((SearchView.SearchAutoComplete.access$100(SearchView.this.mSearchSrcTextView)) || (!paramKeyEvent.hasNoModifiers()) || (paramKeyEvent.getAction() != 1) || (paramInt != 66));
    ...
    this.mSearchSrcTextView.setOnFocusChangeListener(new View.OnFocusChangeListener()
    {
      public void onFocusChange(View paramView, boolean paramBoolean)
      {
        if (SearchView.this.mOnQueryTextFocusChangeListener != null)
          SearchView.this.mOnQueryTextFocusChangeListener.onFocusChange(SearchView.this, paramBoolean);
      }
    });
