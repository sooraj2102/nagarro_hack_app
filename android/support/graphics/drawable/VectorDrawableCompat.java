...
public class VectorDrawableCompat extends VectorDrawableCommon
{
  ...
  public void draw(Canvas paramCanvas)
  {
    ...
    while (true)
    {
      ...
      break;
      label314: if (this.mVectorState.canReuseCache())
        continue;
      this.mVectorState.updateCachedBitmap(k, m);
  ...
  private static class VClipPath extends VectorDrawableCompat.VPath
  {
    ...
    public void inflate(Resources paramResources, AttributeSet paramAttributeSet, Resources.Theme paramTheme, XmlPullParser paramXmlPullParser)
    {
      if (!TypedArrayUtils.hasAttribute(paramXmlPullParser, "pathData"))
        return;
      TypedArray localTypedArray = TypedArrayUtils.obtainAttributes(paramResources, paramTheme, paramAttributeSet, AndroidResources.STYLEABLE_VECTOR_DRAWABLE_CLIP_PATH);
  ...
  private static class VFullPath extends VectorDrawableCompat.VPath
  {
    ...
    public void inflate(Resources paramResources, AttributeSet paramAttributeSet, Resources.Theme paramTheme, XmlPullParser paramXmlPullParser)
    {
      TypedArray localTypedArray = TypedArrayUtils.obtainAttributes(paramResources, paramTheme, paramAttributeSet, AndroidResources.STYLEABLE_VECTOR_DRAWABLE_PATH);
      updateStateFromTypedArray(localTypedArray, paramXmlPullParser);
      localTypedArray.recycle();
    }
  ...
  private static class VGroup
  {
    ...
    public VGroup(VGroup paramVGroup, ArrayMap<String, Object> paramArrayMap)
    {
      ...
      while (i < localArrayList.size())
      {
        ...
        label329: throw new IllegalStateException("Unknown object in the tree!");
      }
    }
    ...
    public void inflate(Resources paramResources, AttributeSet paramAttributeSet, Resources.Theme paramTheme, XmlPullParser paramXmlPullParser)
    {
      TypedArray localTypedArray = TypedArrayUtils.obtainAttributes(paramResources, paramTheme, paramAttributeSet, AndroidResources.STYLEABLE_VECTOR_DRAWABLE_GROUP);
      updateStateFromTypedArray(localTypedArray, paramXmlPullParser);
      localTypedArray.recycle();
    }
  ...
  private static class VPathRenderer
  {
    ...
    private void drawPath(VectorDrawableCompat.VGroup paramVGroup, VectorDrawableCompat.VPath paramVPath, Canvas paramCanvas, int paramInt1, int paramInt2, ColorFilter paramColorFilter)
    {
      ...
      {
        this.mRenderPath.addPath(localPath1, this.mFinalPathMatrix);
      ...
      if ((localVFullPath.mTrimPathStart != 0.0F) || (localVFullPath.mTrimPathEnd != 1.0F))
      {
        ...
        if (f8 > f9)
        {
          this.mPathMeasure.getSegment(f8, f7, localPath1, true);
          this.mPathMeasure.getSegment(0.0F, f9, localPath1, true);
      ...
      else
      {
        ...
        if (localVFullPath.mFillColor != 0)
        {
          ...
          localPath2 = this.mRenderPath;
          if (localVFullPath.mFillRule != 0)
            break label573;
        }
      }
      label573: for (Path.FillType localFillType = Path.FillType.WINDING; ; localFillType = Path.FillType.EVEN_ODD)
      {
        ...
        return;
        this.mPathMeasure.getSegment(f8, f9, localPath1, true);
        break label274;
      }
    }
