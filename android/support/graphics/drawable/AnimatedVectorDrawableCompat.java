    ...
    if ((i != 1) && ((paramXmlPullParser.getDepth() >= j) || (i != 3)))
    {
      ...
      if (i == 2)
      {
        ...
        if (!"animated-vector".equals(str1))
          break label182;
        TypedArray localTypedArray2 = TypedArrayUtils.obtainAttributes(paramResources, paramTheme, paramAttributeSet, AndroidResources.STYLEABLE_ANIMATED_VECTOR_DRAWABLE);
      ...
      while (true)
      {
        ...
        if (!"target".equals(str1))
          continue;
        localTypedArray1 = paramResources.obtainAttributes(paramAttributeSet, AndroidResources.STYLEABLE_ANIMATED_VECTOR_DRAWABLE_TARGET);
        ...
        if (k != 0)
        {
          if (this.mContext == null)
            break label254;
          setupAnimatorsForTarget(str2, AnimatorInflaterCompat.loadAnimator(this.mContext, k));
        }
        localTypedArray1.recycle();
      }
      label254: localTypedArray1.recycle();
      ...
      if (paramAnimatedVectorDrawableCompatState != null)
      {
        ...
        if (paramAnimatedVectorDrawableCompatState.mVectorDrawable != null)
        {
          ...
          if (paramResources == null)
            break label224;
          this.mVectorDrawable = ((VectorDrawableCompat)localConstantState.newDrawable(paramResources));
        }
        while (true)
        {
          ...
          while (true)
            if (j < i)
            {
              ...
              j++;
              continue;
              label224: this.mVectorDrawable = ((VectorDrawableCompat)localConstantState.newDrawable());
              break;
            }
          setupAnimatorSet();
        }
