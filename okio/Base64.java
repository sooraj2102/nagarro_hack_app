...
final class Base64
{
  ...
  private static String encode(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2)
  {
    ...
    while (j < i)
    {
      ...
      int i6 = i5 + 1;
      arrayOfByte[i5] = paramArrayOfByte2[((0x3 & paramArrayOfByte1[j]) << 4 | (0xFF & paramArrayOfByte1[(j + 1)]) >> 4)];
      int i7 = i6 + 1;
      arrayOfByte[i6] = paramArrayOfByte2[((0xF & paramArrayOfByte1[(j + 1)]) << 2 | (0xFF & paramArrayOfByte1[(j + 2)]) >> 6)];
      k = i7 + 1;
      arrayOfByte[i7] = paramArrayOfByte2[(0x3F & paramArrayOfByte1[(j + 2)])];
      j += 3;
    }
    ...
    try
    {
      while (true)
      {
        ...
        int i3 = i2 + 1;
        arrayOfByte[i2] = paramArrayOfByte2[((0x3 & paramArrayOfByte1[i]) << 4)];
        int i4 = i3 + 1;
        arrayOfByte[i3] = 61;
        (i4 + 1);
        arrayOfByte[i4] = 61;
